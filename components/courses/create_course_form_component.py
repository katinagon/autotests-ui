...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.title_input = Input(page, 'create-course-form-title-input', 'Create course title')
        ...
        self.max_score_input = Input(page, 'create-course-form-max-score-input', 'Create course max score')
        self.min_score_input = Input(page, 'create-course-form-min-score-input', 'Create course min score')
